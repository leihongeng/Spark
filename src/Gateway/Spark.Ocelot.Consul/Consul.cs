namespace Ocelot.Provider.Consul
{
    ...
    public class Consul : IServiceDiscoveryProvider
    {
        ...
        public Consul(ConsulRegistryConfiguration config, IOcelotLoggerFactory factory, IConsulClient consulClient)
        {
        ...
        {
            serviceEntry.Service.Address = serviceEntry.Service.Address.Replace("http://", "").Replace("https://", "");
